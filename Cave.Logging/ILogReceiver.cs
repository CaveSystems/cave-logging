...
namespace Cave.Logging
{
    ...
    public interface ILogReceiver : IDisposable
    {
        ...
        /// <summary>
        /// Gets a value indicating whether the receiver is idle or not.
        /// </summary>
        bool Idle { get; }
        ...
        /// <summary>
        /// Gets or sets the <see cref="LogLevel"/> of the receiver (will not receive notifications with log level greater then this).
        /// </summary>
        ...
        /// <summary>
        /// Gets the name of the log receiver.
        /// </summary>
        string Name { get; }
