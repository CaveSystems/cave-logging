...
/// <summary>Provides an interface for log output.</summary>
public interface ILogTarget
{
    #region Properties

    /// <summary>Gets or sets a value indicating whether invert the color (use color as background highlighter).</summary>
    bool Inverted { get; set; }

    /// <summary>Gets or sets the current text color.</summary>
    LogColor TextColor { get; set; }

    /// <summary>Gets or sets the current text color.</summary>
    LogStyle TextStyle { get; set; }
    ...
    /// <param name="text">The <see cref="LogText"/> instance to write.</param>
    /// <returns>Returns the number of newlines printed.</returns>
    int Write(LogText text);

    /// <summary>Writes a LogText to the console (with formatting).</summary>
    /// <param name="item">The <see cref="LogTextItem"/> instance to write.</param>
    /// <returns>Returns the number of newlines printed.</returns>
    int Write(LogTextItem item);
